...
def train(model,optimizer,train_dataloader,val_dataloader,modelname : str,device="cpu",epoch_verbose : int = 10,early_stop_iter=10 ):
    ...
    for epoch in range(N_epochs):
        ...
        for image,labels_list,gt_box_list in train_dataloader:
            ...
            Loss_loc,Loss_conf,no_pos=criterion(gt_box_list,labels_list,regressions,classifications)
            if no_pos:
