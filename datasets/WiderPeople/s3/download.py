...
def load_data():
    ...
    train_dir = os.path.join(project_root, "datasets", "WiderPeople", "train")
    val_dir = os.path.join(project_root, "datasets", "WiderPeople", "val")
    test_dir = os.path.join(project_root, "datasets", "WiderPeople", "test")

    for d in [train_dir, val_dir, test_dir]:
        os.makedirs(d, exist_ok=True)

    downloads = [
        (f"{BUCKET}/FastCrowdVision/datasets/WiderPeople/train/images", train_dir),
        (f"{BUCKET}/FastCrowdVision/datasets/WiderPeople/train/labels", train_dir),
        (f"{BUCKET}/FastCrowdVision/datasets/WiderPeople/val/images", val_dir),
        (f"{BUCKET}/FastCrowdVision/datasets/WiderPeople/val/labels", val_dir),
        (f"{BUCKET}/FastCrowdVision/datasets/WiderPeople/test/images", test_dir),
    ]
